...
public class SimpleSaxWriter {
    public static void main(String[] args) throws SAXException,
        ...
        saxHandler.startElement("[http://schemas.xmlso...envelope/](http://schemas.xmlsoap.org/soap/envelope/)",
        ...
        saxHandler.endElement("[http://schemas.xmlso...envelope/](http://schemas.xmlsoap.org/soap/envelope/)",
                "Body", "soapenv:Body");
        saxHandler.endElement("[http://schemas.xmlso...envelope/](http://schemas.xmlsoap.org/soap/envelope/)",
