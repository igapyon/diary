...
コマンドラインjava -classpath axis.jar;commons-logging-1.0.4.jar;commons-discovery-0.2.jar;jaxrpc.jar;saaj.jar;wsdl4j-1.5.1.jar
      org.apache.axis.wsdl.WSDL2Java -t -s WsTest01.jws.wsdl
呼び出し側の SOAPを利用するクライアントは下記のようになります。
TestCaller.javaimport java.rmi.RemoteException;
...
public class HttpCaller {
    ...
    private static void callMethod(boolean isSysout) {
        ...
        String request = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                ...
                + " xmlns:xsi=\"[http://www.w3.org/2001/XMLSchema-instance](http://www.w3.org/2001/XMLSchema-instance)\">"
                + "  <soapenv:Body>"
                + "    <ns1:method01 soapenv:encodingStyle=\"[http://schemas.xmlsoap.org/soap/encoding/](http://schemas.xmlsoap.org/soap/encoding/)\""
                + " xmlns:ns1=\"http://DefaultNamespace\">"
                ...
                + " soapenv:encodingStyle=\"[http://schemas.xmlsoap.org/soap/encoding/](http://schemas.xmlsoap.org/soap/encoding/)\""
                + " xsi:type=\"xsd:int\""
                + " xmlns:soapenc=\"[http://schemas.xmlsoap.org/soap/encoding/](http://schemas.xmlsoap.org/soap/encoding/)\">123</multiRef>"
