[top](https://igapyon.github.io/diary/) 
 ...
 / [source](https://github.com/igapyon/diary/blob/gh-pages/2008/ig080925.html.src.md) 
...
Eclipse Ganymede SR1 および Eclipse Classic (SDK) 3.4.1 がリリースされています。
ただし、ミラー同期が行き渡っていないので、日本から普通にダウンロードできるようになるのは、明日まで待たないといけないかも知れません。みなさま、もう少々お待ち下さい。
...
Eclipse Ganymede SR1 のミラー・サイトへの同期が行き渡る前に、ウェブページ上の記載が SR1 を指し示してしまったような気がします。そのため、ダウンロードがメインサイトに殺到し、ミラーへの同期が低速化しているように想像できます。通信輻輳による混乱っぽいです。
もし本当にそうなのだとしたら、今回の混乱の原因は Eclipse 側の段取りミスである可能性が高いです。Eclipse Ganymede (3.4)
の時にはこんなことは無く、ミラーへの同期が行き渡ってからウェブページ上の記載変更という段取りが成功していたように記憶します。ああ、とりあえず
はやくミラー同期が行き渡ることを期待します。
