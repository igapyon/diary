...
Subversion設定ファイルを Excelから自動生成するパスについて検討を開始しました。
[blanco Framework](http://www.igapyon.jp/blanco/blanco.ja.html)による提供となります。まずは プロダクト名を考慮中です。
2008.01.18追記 プロダクト名は [blancoSvnConf](http://www.igapyon.jp/blanco/blancosvnconf.html)に決まりました。
