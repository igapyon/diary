...
* [Markdown](https://igapyon.github.io/diary/keyword/markdown.html) ベースのコンテンツ記述
* 過去の他システム日記データの活用
  * 単純HTML
  * hatena
* [github](https://igapyon.github.io/diary/keyword/github.html) の gh-pages 上での稼働可能性
  * 利用する Markdown を基本的には github の [gh-pages](https://igapyon.github.io/diary/keyword/gh-pages.html) 範囲内に抑える
...
* コンテンツのソース
  ...
  * 日記ジェネレータそのものは別リポジトリを立てたうえで [OSS](https://igapyon.github.io/diary/keyword/oss.html) 化する予定
* 過去の日記の場所
