...
* Selenium HQ
  * <@link value="http://www.seleniumhq.org/" />
  * 今見たら、たいていの記述が Selenium 2 ベースのままでした。
* Selenium Maven Repos
  * <@link value="http://repo1.maven.org/maven2/org/seleniumhq/selenium/" />
  * コンパイル済み Java ファイルのダウンロードに便利です。
* Selenium Source code
  * <@link value="https://github.com/SeleniumHQ/selenium/releases" />
  * 2016/11/08 時点で 3.0.1 がダウンロード可能
* ChromeDriver - WebDriver for Chrome
  * <@link value="https://sites.google.com/a/chromium.org/chromedriver/" />
...
* Selenium 2 最終
  * <@link value="http://selenium-release.storage.googleapis.com/index.html?path=2.53/" />
