...
# [blancoNLpackGenerator](https://www.igapyon.jp/blanco/blanconlpackgenerator.html) と Eclipse Ganymede 日本語化言語パック翻訳成果とを併用してビルドを実施しただけのものです。
...
単に Eclipse の Windows 版インストーラが必要な方は、[BlancoEclipseDistribution](https://www.igapyon.jp/blanco/blancoeclipsedistribution.html)安定版を取得してください。

* [BlancoEclipseDistribution](https://www.igapyon.jp/blanco/blancoeclipsedistribution.html) 安定版
