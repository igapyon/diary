...
[blanco Framework](http://www.igapyon.jp/blanco/blanco.ja.html) は SQL整形とSQLカラー表示が特徴の オープンソース [Eclipse](https://www.igapyon.jp/igapyon/diary/keyword/eclipse.html)プラグインである[BlancoSqlEditorPlugin](http://www.igapyon.jp/blanco/blancosqleditorplugin.html) (1.0.0) をリリースをしました。
