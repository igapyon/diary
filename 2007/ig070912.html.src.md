...
[blancoMail](http://www.igapyon.jp/blanco/blancomail.html)のコアAPIである [blancoMailCore](http://www.igapyon.jp/blanco/blancomailcore.html)ですが、結構
いろいろな実装をする必要がありそうだということがわかってきました。特にログ回りや異常系について、メール送受信という特性がら、まあ ほんとうに
いろいろ処理が必要な見込みです。
世間のニュースから
