...
<@link value="https://www.igapyon.jp/blanco/" /> のほうが 利用可能なコンテンツ容量が多いので、大量の画像ファイルなどは <@link value="https://www.igapyon.jp/blanco/" />のみに格納する予定です。(この方法だと HTMLを書く手間が少し増えますが、容量の都合 仕方がないのです)
