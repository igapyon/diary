...
```
ffmpeg -ss 470  -t 4645 -i 250429_125454_TrMic-concat.wav -c copy 250429_125454_TrMic-part1.wav
ffmpeg -ss 470  -t 4645 -i 250429_125454_Tr1-concat.wav -c copy 250429_125454_Tr1-part1.wav
```
...
```
ffmpeg -loop 1 -framerate 2 -i TazukuriBeethoven1.png -i 250429_part1_TrMic.wav -c:v libx264 -preset medium -tune stillimage -crf 18 -c:a copy -shortest -pix_fmt yuv420p 250429_part1_TrMic.mkv

ffmpeg -loop 1 -framerate 2 -i TazukuriBeethoven2.png -i 250429_part1_Tr1.wav -c:v libx264 -preset medium -tune stillimage -crf 18 -c:a copy -shortest -pix_fmt yuv420p 250429_part1_Tr1.mkv
```
...
```
ffmpeg -i 250429_part1_TrMic.wav -c:a aac -b:a 192k 250429_part1_TrMic.m4a
ffmpeg -i 250429_part1_Tr1.wav -c:a aac -b:a 192k 250429_part1_Tr1.m4a
```
