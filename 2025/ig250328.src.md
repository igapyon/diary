...
から ggml-large-v3.bin をダウンロード

```
whisper-cpp -f 250531_111055_TrMic-loudnorm.wav -m ggml-large-v3.bin -l ja -t 8 > 250531_111055.txt
```

```
/tmp/whisper.cpp/build/bin/whisper-cli -f 250531_111055_TrMic-loudnorm.wav -m ggml-large-v3.bin -l ja -t 8 > 250531_111055.txt
```
