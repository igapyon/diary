...
* InterBase ToGo をもちいたアプリケーションの配布のしかた
  ...
  * [http://docs.embarcad...p4_ja.pdf](http://docs.embarcadero.com/products/interbase/IBXE3Update4_JP/ToGoQS_XE3up4_ja.pdf)



* データベースファイルサイズの上限は、デフォルトのページサイズ(4KB)の場合、8TB になります。
  *   [操作ガイド - InterBase の制限]
  *   [http://docs.embarcad...p4_ja.pdf](http://docs.embarcadero.com/products/interbase/IBXE3Update4_JP/OpGuide_XE3up4_ja.pdf)
...
* 2014-09-24 [InterBase] InterBase の情報源メモ
  * [http://d.hatena.ne.j.../20140924](http://d.hatena.ne.jp/igapyon/20140924)
