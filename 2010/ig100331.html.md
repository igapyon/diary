[top](../index.html) 
 ...
 / [source](https://github.com/igapyon/diary/blob/gh-pages/2010/ig100331.src.md) 
...
public class Sample {
    ...
    public static String translateByGoogle(final String sourceLang,
        ...
        final String uri = "[http://translate.google....ent=t&text=](http://translate.google.co.jp/translate_a/t?client=t&text=)"
                + sourceLine
                + "&hl=ja"
                + "&sl="
                + sourceLang
