[top](https://igapyon.github.io/diary/) 
 ...
 / [prev](https://igapyon.github.io/diary/2010/ig100328.html) 
 / [next](https://igapyon.github.io/diary/2010/ig100404.html) 
...
public class Sample {
    ...
    public static String translateByGoogle(final String sourceLang,
        ...
        final String uri = "[http://translate.google.co.j.../t?client=t&text=](http://translate.google.co.jp/translate_a/t?client=t&text=)"
                + sourceLine
                + "&hl=ja"
                + "&sl="
                + sourceLang
