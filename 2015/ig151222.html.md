...
ここの例では、[Delphiでバリューオブジェクト](http://d.hatena.ne.jp/igapyon/20151220)で作成したバリューオブジェクトをもちいて、JSON 文字列を取得します。ここで利用している型は、うつくしく JSON との相互変換が (デフォルトの挙動として) 実現が可能なものです。
...
バイナリを扱う場合 [Delphi バリューオブジェクトでバイナリ利用](http://d.hatena.ne.jp/igapyon/20151221) で示すようにバリューオブジェクトをつくると、適切かつ美しく JSON 直列化を実現することができます。例えば TImage の画像データを扱う場合には、ストリームを経由して TBytes に相互変換してから直列化するのです。
...
* [2015-12-20 Delphiでバリューオブジェクト](http://d.hatena.ne.jp/igapyon/20151220)
* [2015-12-21 Delphi バリューオブジェクトにおけるバイナリの利用](http://d.hatena.ne.jp/igapyon/20151221)
* [2015-12-22 Delphi オブジェクトのJSON直列化](http://d.hatena.ne.jp/igapyon/20151222)
* [2015-12-03 Delphi: REST.JSON を利用したオブジェクトの直列化](http://d.hatena.ne.jp/igapyon/20151203)
