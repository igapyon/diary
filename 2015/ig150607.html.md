...
* [http://www.omegat.org/ja/omegat.html:title=OmegaT：自由に使える（GPL）翻訳メモリツール]
...
* [http://svn.osdn.jp/svnroot/benten/trunk/benten.cat.glossary.data.tsv/glossary/BlancoNLpackGeneratorGlossary.tsv:title=Benten のサンプル英日 Glossary] : ファイル名を .tsv から .utf8 に変更すると OmegaT が認識します。
* [http://osdn.jp/projects/blancofw/releases/p7679:title=Pleiades 由来のサンプル英日 TMX] : リンク先の http://osdn.jp/projects/blancofw/downloads/52952/pleiades.tmx-1.3.3.zip の .zip を展開して得られる .tmx ファイルを利用します。
