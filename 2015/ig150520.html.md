...
* インターネット上に公開されているソースコード
  * サンプルのソースコード: [http://sourceforge.net/p/rad...AD/tree/branches/](http://sourceforge.net/p/radstudiodemos/code/HEAD/tree/branches/)
    * 過去バージョンのサンプルも公開されているので、それらを入手したい場合にはとても便利です。
  * Delphi 向けコードエグザンプルの全リスト
    * [http://docwiki.embarcadero.c...s/XE8/en/Category](http://docwiki.embarcadero.com/CodeExamples/XE8/en/Category):Delphi
