...
* インターネット上に公開されているソースコード
  * サンプルのソースコード: <@link value="http://sourceforge.net/p/radstudiodemos/code/HEAD/tree/branches/" />
    * 過去バージョンのサンプルも公開されているので、それらを入手したい場合にはとても便利です。
  * Delphi 向けコードエグザンプルの全リスト
    * <@link value="http://docwiki.embarcadero.com/CodeExamples/XE8/en/Category" />:Delphi
