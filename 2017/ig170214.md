...
`Add .gitignore` をクリックして、`Maven` を選択します。
...
これでリポジトリ作成が完了します。
このリポジトリが作成されるときに表示される [https://github.com/igapyon/mydiary.git](https://github.com/igapyon/mydiary.git) のような文字列をメモしておくと後で便利です。
