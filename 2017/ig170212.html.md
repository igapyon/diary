...
[2017-02-09 diary: [github] に [gh-pages] 日記を作成するときの基本手順メモ](https://igapyon.github.io/diary/2017/ig170209.html) により gh-pages の初期設定を実施するか、それ相当の設定を完了させていることを前提とします。
