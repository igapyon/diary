...
2017-01-27 diary: [Ant] sf の URL を osdn に置き換え
=====================================================================================================
...
```xml
  <replaceregexp encoding="UTF-8" byline="true">
    <regexp pattern="[http://sourceforge.jp/projects/](http://sourceforge.jp/projects/)" />
    <substitution expression="[https://ja.osdn.net/projects/](https://ja.osdn.net/projects/)" />
    <fileset dir=".">
      <include name="**/*.src.md" />
    </fileset>
  </replaceregexp>
