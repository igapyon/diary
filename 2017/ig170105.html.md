...
[ROME](https://igapyon.github.io/diary/keyword/rome.html) による Atom XML の入出力をいろいろ試してみました。現時点での [RSS](https://igapyon.github.io/diary/keyword/rss.html) / Atom 入出力には ROME ライブラリが適切かと現時点では考えています。
