...
今日DVDオーサリングをしていて、生AVIのまま がりがり編集したあと[MPEG2](null)に変更するよりも 先に [MPEG2](null)化してから[DVD](null)[オーサリング](null)したほうがとっても簡便であることが判明。[MPEG2](null)の特性により、フレーム毎の編集は不可能ですが、簡便さが圧倒的に違い、やはり先に[MPEG2](null)化が好適であるということを実感しました。
