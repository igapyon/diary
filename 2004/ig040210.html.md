...
Project Amaterasというところのカウンタは機能は少ないですが、javaでantでの実行が可能です失礼、ＵＲＬを書く前に押しちゃいました。[http://amateras.sour...unterJava](http://amateras.sourceforge.jp/cgi-bin/fswiki/wiki.cgi?page=StepCounterJava)で書かれているっていうのは とっても魅力ですね。ツッコミ、ありがとうございますです。
