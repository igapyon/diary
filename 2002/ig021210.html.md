...
```
        net_URL* url = new net_URL((unsigned char*)"[http://www.tcct.zaq.ne.jp/ig...ki/igapyon/diary/](http://www.tcct.zaq.ne.jp/iga/tosiki/igapyon/diary/)");
