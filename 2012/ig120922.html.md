...
* Debian policy for Java
  * [http://www.debian.org/do...s/java-policy/](http://www.debian.org/doc/packaging-manuals/java-policy/)
...
* [http://bugs.debian.org/c...cgi?bug=551866](http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=551866)
...
* [http://search.gmane.org/...p&author=Jakub](http://search.gmane.org/?query=wtp&author=Jakub)+Adam&group=&sort=date&DEFAULTOP=and&xFILTERS=Aadam-Ajakub---A
...
* Debian Java Packaging Project
  ...
  * [https://alioth.debian.or...ects/pkg-java/](https://alioth.debian.org/projects/pkg-java/)
  * [http://anonscm.debian.org/gitweb/](http://anonscm.debian.org/gitweb/)
* Java のリクエスト済みパッケージ
  * [http://wiki.debian.org/J...uestedPackages](http://wiki.debian.org/Java/RequestedPackages)
* それが、どうなっているのか
  * [http://www.debian.org/de...being_packaged](http://www.debian.org/devel/wnpp/being_packaged)
