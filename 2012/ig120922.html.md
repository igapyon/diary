...
* Debian policy for Java
  * [http://www.debian.or...a-policy/](http://www.debian.org/doc/packaging-manuals/java-policy/)
...
* [http://bugs.debian.o...ug=551866](http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=551866)
...
* [http://search.gmane....hor=Jakub](http://search.gmane.org/?query=wtp&author=Jakub)+Adam&group=&sort=date&DEFAULTOP=and&xFILTERS=Aadam-Ajakub---A
...
* Debian Java Packaging Project
  * [http://pkg-java.alio...bian.org/](http://pkg-java.alioth.debian.org/)
  * [https://alioth.debia...pkg-java/](https://alioth.debian.org/projects/pkg-java/)
  * [http://anonscm.debia...g/gitweb/](http://anonscm.debian.org/gitweb/)
* Java のリクエスト済みパッケージ
  * [http://wiki.debian.o...dPackages](http://wiki.debian.org/Java/RequestedPackages)
* それが、どうなっているのか
  * [http://www.debian.or..._packaged](http://www.debian.org/devel/wnpp/being_packaged)
