...
2006.03.26追記 とある状況変化により、JavaScriptソースコード自動生成の優先度が下がりました。このため、blanco Frameworkの JavaScript対応は
実現時期が少し先のこととなります。

2006.05.17追記 JavaScriptソースコード自動生成は [blancoCg](http://www.igapyon.jp/blanco/blancocg.html)に組み込むことになりました。現在 [blancoCg](http://www.igapyon.jp/blanco/blancocg.html)
