...
[blanco Framework](http://www.igapyon.jp/blanco/blanco.ja.html)の次世代型ソースコード生成ライブラリである [blancoCg](http://www.igapyon.jp/blanco/blancocg.html)
が 少し進捗しました。週末や帰宅後の時間を使って こつこつと開発しています。生成対象をJava言語だけに限って考えると、ある程度が実装済みの状態になりました。blancoCodeGenerator次世代版と組み合わせて、blanco
