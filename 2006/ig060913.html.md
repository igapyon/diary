...
「文字グループ定義書」に続き、[blanco Framework](http://www.igapyon.jp/blanco/blanco.ja.html)として「文字列グループ定義書」というExcel様式を入力として、文字列グループを処理するクラス・ソースコードを作成するツール
[blancoStringGroup](http://www.igapyon.jp/blanco/blancostringgroup.html)を新規作成しました。
